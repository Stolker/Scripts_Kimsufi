...
if [ "$DISTRO" = SUSE ]; then
  ...
  cp /lib/x86_64-linux-gnu/libnss_compat.so.2 /lib/x86_64-linux-gnu/libnsl.so.1 /lib/x86_64-linux-gnu/libnss_files.so.2 /lib/x86_64-linux-gnu/libcap.so.2 /lib/x86_64-linux-gnu/libcap.so.2.25 /lib/x86_64-linux-gnu/libnss_dns.so.2 ${JAILPATH}/lib/x86_64-linux-gnu/
else
